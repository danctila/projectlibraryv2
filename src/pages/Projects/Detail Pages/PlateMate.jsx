      ...
      >
        ...
        <motion.div variants={fadeIn} className="mb-16">
          ...
          <div className="max-w-none">
            <div className="text-[20px] text-[#645E6E] dark:text-[#D8D6DC] leading-[25px]">
        ...
        <motion.div variants={fadeIn} className="mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
            {project.images.map((image, index) => (
              <motion.div
                key={index}
                className="group relative aspect-[16/10] bg-gray-100 dark:bg-gray-800 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer"
          ...
          {selectedImage && (
            ...
            >
              <motion.div
                ...
                className="relative w-[95vw] h-[95vh] flex flex-col items-center justify-center"
              >
                <img
                  src={selectedImage}
                  alt="Enlarged view"
                ...
                <button
                  className="absolute top-4 right-4 w-10 h-10 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center text-white hover:bg-white/20 transition-all duration-200"
                  onClick={(e) => {
                    e.stopPropagation();
